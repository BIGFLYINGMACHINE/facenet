...
## This is a repository forked from https://github.com/davidsandberg/facenet
我做了一些改变，以适应自己项目的要求。包括人脸检测的方法，并添加了在视频中识别人脸的程序
## Compatibility
The code is tested using Tensorflow r1.7 under Ubuntu 16.04 with Python 2.7 and Python 3.5.
